...
int main(void)
{
  ...
  // Enable the LL SPI controller (Taken from Week 6 lab)
  LL_SPI_Enable(SPI1);

  // Start ADC in interrupt mode
  // note: adc external trigger is TIM1_TRGO, the adc will wait for tim1 trigger events to only start running
